...
// styles.css (TinkerQuarry's UI is English; the other subsets would be committed dead weight).
import App from './App'
...
if (!root) throw new Error('TinkerQuarry: #root element missing from index.html')
