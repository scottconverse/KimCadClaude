...
`)}var Gs=new J;function Ks(e){Y._getMatrix(Gs,Y.workingColorSpace,e);let t=`mat3( ${Gs.elements.map(e=>e.toFixed(4))} )`;switch(Y.getTransfer(e)){case nt:return[t,`LinearTransferOETF`];case rt:return[t,`sRGBTransferOETF`];default:return U(`WebGLProgram: Unsupported color space: `,e),[t,`LinearTransferOETF`]}}function qs(e,t,n){let r=e.getShaderParameter(t,e.COMPILE_STATUS),i=(e.getShaderInfoLog(t)||``).trim();if(r&&i===``)return``;let a=/ERROR: 0:(\d+)/.exec(i);if(a){let r=parseInt(a[1]);return n.toUpperCase()+`
